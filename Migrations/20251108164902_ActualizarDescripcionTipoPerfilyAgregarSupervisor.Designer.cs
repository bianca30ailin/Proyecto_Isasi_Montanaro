...
namespace Proyecto_Isasi_Montanaro.Migrations
{
    ...
    [Migration("20251108164902_ActualizarDescripcionTipoPerfilyAgregarSupervisor")]
    partial class ActualizarDescripcionTipoPerfilyAgregarSupervisor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyecto_Isasi_Montanaro.Models.DetalleNotaCredito", b =>
                {
                    b.Property<int>("IdDetalleNotaCredito")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdDetalleNotaCredito"));
            ...
            modelBuilder.Entity("Proyecto_Isasi_Montanaro.Models.FormaPago", b =>
                {
                    ...
                    b.HasKey("IdFormaPago")
                        .HasName("PK__forma_pa__DD4926E39FCE6D1E");
            ...
            modelBuilder.Entity("Proyecto_Isasi_Montanaro.Models.NotaCredito", b =>
                {
                    b.Property<int>("IdNotaCredito")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyecto_Isasi_Montanaro.Models.DetalleNotaCredito", b =>
                {
                    b.HasOne("Proyecto_Isasi_Montanaro.Models.NotaCredito", "NotaCredito")
                        .WithMany("Detalles")
                        .HasForeignKey("IdNotaCredito")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Proyecto_Isasi_Montanaro.Models.Producto", "Producto")
                        .WithMany()
            ...
            modelBuilder.Entity("Proyecto_Isasi_Montanaro.Models.NotaCredito", b =>
                {
                    b.HasOne("Proyecto_Isasi_Montanaro.Models.Ventum", "Venta")
                        .WithMany()
                        .HasForeignKey("IdNroVenta")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Proyecto_Isasi_Montanaro.Models.Producto", b =>
                {
                    ...
                    b.HasOne("Proyecto_Isasi_Montanaro.Models.Usuario", "UsuarioCreacion")
            ...
            modelBuilder.Entity("Proyecto_Isasi_Montanaro.Models.Ventum", b =>
                {
                    ...
                    b.HasOne("Proyecto_Isasi_Montanaro.Models.FormaPago", "IdFormaPagoNavigation")
                        .WithMany("Ventas")
